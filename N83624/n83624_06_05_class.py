...
class n83624_06_05_class_tcp:
    ...
    def set_voltage_from_array(self, v_array, start_ch=1):
        for z, cell_volt in enumerate(v_array):
            ch_num = z + start_ch  # Calculate channel number once
            ch_num = range_check(ch_num, self._s_ch, self._e_ch_all, "set_voltage_from_array VAR: ch_num")
            cell_volt = range_check(cell_volt, ngi_min_voltage, ngi_max_voltage, "set_voltage_from_array VAR: item")
            # print(z, ch_num, cell_volt)
